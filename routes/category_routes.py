...
@categories.route('/category/delete/<category_id>/<service_id>', methods=['DELETE'])
def delete_category_by_id(category_id, service_id):
    return controllers.delete_category_by_id(request, category_id, service_id)
